import { pgTable, integer, timestamp, text, boolean, varchar } from 'drizzle-orm/pg-core';
import { createSelectSchema, createInsertSchema } from 'drizzle-orm/zod';

import { items } from './items';
import { entityTrustapTransactionTypeEnum } from './enumerated_types';

export const entityTrustapTransactions = pgTable('entity_trustap_transactions', {
